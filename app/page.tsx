...
const defaultCalendlyUrl = "https://calendly.com/nicolascolony/30min";
...
const reviews = [
  {
    name: "Apeksha Jain",
    text: "Amazing service, best price, and a well-spoken manager.",
  },
  {
    name: "Chris M",
    text: "Best customer service, nice employees, and great work. I really appreciate them.",
  },
  {
    name: "Local Customer",
    text: "Fast repair, clean work, and super helpful staff.",
  },
];

function GoogleLogo({ small = false }: { small?: boolean }) {
  return (
    <div
      className={`font-black leading-none ${small ? "text-xl" : "text-6xl"}`}
...
export default function CellairisModernWebsite() {
  ...
  const filteredRepairs = useMemo(() => {
    return current.repairs.filter((item) =>
  ...
  const bookAtLocation = (index: number) => {
    ...
    window.open(chosenLocation.calendlyUrl || defaultCalendlyUrl, "_blank", "noreferrer");
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-lg text-neutral-300">
              Phones, tablets, laptops, gaming consoles, smart watches, charging ports,
              batteries, screens, back glass, and more — repaired by trusted local
              technicians in San Antonio.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button
                onClick={openBooking}
                className="rounded-2xl bg-red-500 px-7 py-6 text-base font-bold hover:bg-red-600"
              >
              ...
              <Button
                asChild
                variant="outline"
                className="rounded-2xl border-white/20 bg-white/5 px-7 py-6 text-base text-white hover:bg-white/10"
              >
                <a href="#locations">Call a Location</a>
              </Button>
            </div>
          </motion.div>
          ...
          >
            <Card
              id="quote"
              className="rounded-[2rem] border-white/10 bg-white/10 shadow-2xl backdrop-blur-xl"
            >
              <CardContent className="p-6 md:p-8">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-300">
                      Choose your device and repair type.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <label className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-neutral-900 p-4 text-white"
                    >
                  ...
                  <label className="space-y-2">
                    ...
                    <div className="flex items-center rounded-2xl border border-white/10 bg-neutral-900 px-4">
                      ...
                      <input
                        ...
                        placeholder="screen, battery, HDMI..."
                        className="w-full bg-transparent p-4 text-white placeholder:text-neutral-500 outline-none"
                      />
                    </div>
                  </label>
                </div>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  {filteredRepairs.map((item) => (
                    <button
                      ...
                      className={`rounded-2xl border p-4 text-left text-sm text-white transition ${
                        repair === item
                          ? "border-red-400 bg-red-500/20"
                          : "border-white/10 bg-white/5 hover:bg-white/10"
                      }`}
                ...
                {repair === "Other" && (
                  <textarea
                    ...
                    placeholder="Tell us what repair you need..."
                    className="mt-4 min-h-28 w-full rounded-2xl border border-white/10 bg-neutral-900 p-4 text-white outline-none"
                  />
                )}
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-neutral-900 p-4">
                  ...
                  <p className="mt-1 font-bold text-white">
                    <Icon className="mr-2 inline h-5 w-5 text-red-400" />
                    {device} · {brand} ·{" "}
                    {repair === "Other" ? otherRepair || "Other repair" : repair}
                  </p>
                </div>

                <Button
                  onClick={openBooking}
                  className="mt-6 w-full rounded-2xl bg-red-500 py-6 text-base font-bold hover:bg-red-600"
                >
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-neutral-400">
            Quick diagnostics, clear pricing, and same-day service on many repairs.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          ...
          >
            <Card className="rounded-3xl border-white/10 bg-white/5">
              <CardContent className="p-7">
                <Zap className="mb-5 h-8 w-8 text-red-400" />
                <h3 className="text-xl font-bold text-white">Same-Day Repairs</h3>
                <p className="mt-3 text-neutral-400">
                  Most common phone repairs can be completed quickly while you shop.
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="rounded-3xl border-white/10 bg-white/5">
              <CardContent className="p-7">
                <ShieldCheck className="mb-5 h-8 w-8 text-red-400" />
                <h3 className="text-xl font-bold text-white">Quality Parts</h3>
                <p className="mt-3 text-neutral-400">
                  Clean installs, careful testing, and reliable parts for daily use.
                </p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="rounded-3xl border-white/10 bg-white/5">
              <CardContent className="p-7">
                <Phone className="mb-5 h-8 w-8 text-red-400" />
                <h3 className="text-xl font-bold text-white">All Major Devices</h3>
                <p className="mt-3 text-neutral-400">
                  Apple, Samsung, tablets, laptops, consoles, smart watches, and more.
                </p>
              </CardContent>
            </Card>
          </motion.div>
      ...
      <section id="locations" className="bg-white px-6 py-16 text-neutral-950">
        <div className="mx-auto max-w-7xl rounded-[2rem] bg-neutral-950 p-8 text-white md:p-12">
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-4 text-neutral-300">
                Cellairis and Techy locations across San Antonio for phones, tablets,
                laptops, consoles, and accessories.
              </p>
              <p className="mt-2 text-neutral-400">
                Book online, call the store, or stop by for same-day service on many repairs.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row md:justify-end">
              <Button
                onClick={openBooking}
                className="rounded-2xl bg-red-500 px-7 py-6 font-bold hover:bg-red-600"
              >
                Book Appointment
              </Button>
              ...
              <Button
                asChild
                variant="outline"
                className="rounded-2xl border-white/20 bg-white/5 px-7 py-6 text-white hover:bg-white/10"
              >
                <a href={`tel:${location.tel}`}>Call Selected Store</a>
              </Button>
            </div>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={smoothTransition}
            className="mt-8 overflow-hidden rounded-[1.5rem] border border-white/10 bg-neutral-900 p-3"
          >
                  ...
                  <div className="mb-4 flex items-center justify-between gap-3">
                    <div className="flex gap-1 text-red-400">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <Star key={i} className="h-4 w-4 fill-red-400" />
                      ))}
                    </div>
      ...
      {showBookingModal && (
        ...
        >
          <motion.div
            ...
            animate={{ opacity: 1, y: 0, scale: 1 }}
            transition={smoothTransition}
            className="w-full max-w-3xl rounded-[2rem] border border-white/10 bg-neutral-950 p-6 shadow-2xl md:p-8"
          >
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-neutral-400">
                  Choose the correct store so we send you to the right Calendly
                  appointment page.
                </p>
              </div>
      ...
      <footer className="border-t border-white/10 px-6 py-10 text-center text-sm text-neutral-500">
        ...
        <p className="mt-2">Multiple locations across San Antonio</p>
      </footer>
    </div>
  );
}